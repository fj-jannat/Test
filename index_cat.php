<?php 
	...
	/*if(isset($_POST['Date_from']) and isset($_POST['Date_to'])){
		...
		$sql_upcoming_events = "SELECT * from event where BETWEEN ".$_POST['Date_from']." AND ".$_POST['Date_to']." ORDER BY Event_date DESC";
	}
	else{  */
			...
			<div class="">
                ...
                <div class="row">
					...
					<?php 
						...
						$sql_upcoming_events = "SELECT * from event where event_category='".$_GET['cat']."' ORDER BY Event_date DESC";       
